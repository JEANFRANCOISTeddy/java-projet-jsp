...
/**
 * Servlet implementation class ControlleurUpdateClassroom
 */
@WebServlet("/ControlleurUpdateClassroom")
public class ControlleurUpdateClassroom extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ControlleurUpdateClassroom() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			daoClassroom.update(id, nom, prof, eleves, matiere, devoir);
			response.getWriter().println("La classe a bien ete modifiee");
